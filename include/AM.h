...
#define AME_EOF -1
#define AME_ERROR -2
#define AME_INVALID_FILEDESC_ERROR -3
#define AME_FULL_MEMORY_ERROR -4
#define AME_WRONG_BLOCK_NUMBER -5
#define AME_INVALID_TYPE -6
#define AME_FILE_ALREADY_EXISTS -7
#define AME_INVALID_FILE_ERROR -8
#define AME_FILE_IN_USE -9
#define AME_EMPTY_FILE_ERROR -10
#define AME_OPEN_FILES_LIMIT_ERROR -11
#define AME_OPEN_SCANS_LIMIT_ERROR -12
#define AME_FILE_WITH_OPEN_SCANS -13
